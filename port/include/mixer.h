...
/* no <stdbool.h> here: the game headers typedef their own bool and this
 * header is included from abi.h into game TUs */
#include <stdint.h>
#include <ultra64.h>
...
/* Rare's reverb uses aPoleFilter (a stock ucode op sm64 never used);
 * skipping it just leaves the reverb tail unfiltered. */
#undef aPoleFilter
